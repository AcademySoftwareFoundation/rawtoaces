# rawtoaces Project Roles and Responsibilities

rawtoaces is a project of the Academy Software Foundation and relies on
...
The rawtoaces project grows and thrives from assistance from
...
* Review the coding standards in [CONTRIBUTING.md](CONTRIBUTING.md) to ensure your contribution
...
Project Committers have merge access on the rawtoaces GitHub repository
...
* Ensuring a response to questions posted to the
  [rawtoaces-discussion](https://lists.aswf.io/g/rawtoaces-discussion)
  mail list or the `#rawtoaces` channel on the [ASWF Slack](https://slack.aswf.io/).
...
and valuable contributions to the rawtoaces project to become a new
...
[rawtoaces-discussion@lists.aswf.io](https://lists.aswf.io/g/rawtoaces-discussion),
or privately on the Academy Software Foundation Slack instance.

## Technical Steering Committee

The Technical Steering Committee (TSC) oversees the overall technical
direction of rawtoaces, as defined in the project
...
serves as the rawtoaces representative on the Academy Software
...
Members of the TSC contribute to rawtoaces independent of their employer and
their employer is listed purely for transparency purposes.

* Anton Dukhovnikov (Chair and TAC representative) - Wētā FX

### Former TSC Members

* Alexander Forsythe (former Chair) - Academy of Motion Picture Arts and Sciences

Changes to employment should be updated promptly and will require a pull request.
Such pull requests do not require approval from all members.

### TSC Meetings

All meetings of the TSC are open to participation by any member of the
rawtoaces community. Meeting times are listed on the
[rawtoaces project calendar](https://webcal.prod.itx.linuxfoundation.org/lfx/a092M00001LkKVeQAN).
The TSC Chair moderates the meeting, or appoints another TSC member to
...
Prior to each TSC meeting, the TSC Chair will share the agenda with members
...
The agenda will also be shared on the `#rawtoaces` Slack channel, preferably a
day before if possible.

The TSC may invite additional persons to participate in a non-voting capacity.

The TSC Chair is responsible for archiving meeting minutes.
...
and through the `#rawtoaces` ASWF Slack channel.
