...
See [the documentation](https://rawtoaces.readthedocs.io/en/latest/) for full documentation.
...
```sh
$ brew install cmake ceres-solver nlohmann-json openimageio nanobind robin-map
```
